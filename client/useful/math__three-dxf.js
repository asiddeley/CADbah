//NOT READY...
//TO DO replce THREE refs with babylon

Vector2=require("babylon").Vector;



//Copyright https://github.com/gdsestimating/three-dxf.git
//three-dxf v0.3.0
...
polar = function(point, distance, angle) {
	var result = {};
 ...
 */
BulgeGeometry = function ( startPoint, endPoint, bulge, segments ) {
